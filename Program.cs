...
var connectionString = builder.Configuration.GetConnectionString("WaterparkContextConnection") ?? 
    throw new InvalidOperationException("Строка подключения 'WaterparkContextConnection' не найдена.");
